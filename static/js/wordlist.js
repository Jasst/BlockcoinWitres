...
window.BIP39_WORDLIST = [
      ...
      "labor","ladder","lady","lake","lamp","language","laptop","large","later","latin","laugh",
...
if (window.BIP39_WORDLIST && window.BIP39_WORDLIST.length === 2048) {
    console.log('✅ BIP39 wordlist loaded successfully (2048 words)');
} else {
    console.error('❌ BIP39 wordlist invalid length:', window.BIP39_WORDLIST ? window.BIP39_WORDLIST.length : 'undefined');
}